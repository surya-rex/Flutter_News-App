...
class Today extends StatelessWidget {
  ...
  Future<List<NewsArticle>> fetchData() async {
    ...
    final url =
        'https://newsapi.org/v2/everything?q=tesla&from=2023-08-22&sortBy=publishedAt&apiKey=74a05b1775af4cafaaaffd23a3891d3c'; // Replace with the API endpoint you want to use
